...
[![Passport Version](https://img.shields.io/badge/Passport-v1.1.4-007EC6?style=for-the-badge&logo=securityscorecard&logoColor=white)](https://github.com/little-gt/Passport)
...
| 版本 | 日期 | 主要变更 |
|------|------|----------|
| 1.1.4 | 2026-07-15 | 修复了数据库类型大小写不匹配导致适配程序出现错误的问题 |
